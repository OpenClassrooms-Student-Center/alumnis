...
template: students
description:
    Mon projet consiste à apprendre le développement Python afin d'acquérir les     connaissances et les compétences nécessaires qui me permettront d'aides les     communautés scientifique et médicale dans l'analyse et le traitement de nomb    reuses données biologiques et médicales.
...
projects:
  - title: Présentez-vous !
    description: De formation scientifique et médicale, et après de nombreuses a    nnées de recherche sur les maladies neuromusculaires, j'ai décidé de me reco    nvertir.
