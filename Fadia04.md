...
template: students
description:
    Mon projet consiste à apprendre le développement Python afin d'acquérir les     connaissances et compétences nécessaires qui me permettront d'aider les comm    unautés scientifique et médicale dans l'analyse et le traitement de nombreus    es données biologiques et médicales.
